...
const LoadingCard = () => (
  <div className="text-center text-gray-500">
    {" "}
    <svg
      className="animate-spin mx-auto h-12 w-12 text-yellow-500"
...
const AnalyticsView = () => (
  <div>
    ...
    <h2 className="text-2xl font-bold mb-6">
      Content Analysis & User Behavior
    </h2>{" "}
...
const SettingsView = () => (
  <div>
    ...
    <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl border">
      {" "}
      <h3 className="text-lg font-bold">API Configuration</h3>{" "}
      <p className="text-gray-600 mt-2">
        {" "}
        API keys are managed on the backend server.{" "}
      </p>{" "}
    </div>{" "}
  </div>
);
