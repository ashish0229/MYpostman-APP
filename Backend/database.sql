...
DROP TABLE IF EXISTS refresh_tokens;   -- ✅ NEW — drop first (depends on users)
...
-- ─────────────────────────────────────────────────────────
-- ✅ NEW — refresh_tokens table for secure token rotation
-- ─────────────────────────────────────────────────────────
...
VALUES (
    'admin',
    'Admin User',
    '$2a$10$E9p.IZ3..4A4XbCoaHz65.6.89.s25x0MQzJ9.5aM9b9aZO5.9zse',
    'admin'
)
